...
func (x *GreetResponse) GetAge() int32 {
	if x != nil {
		return x.Age
	}
	return 0
...
const file_greet_v1_greet_proto_rawDesc = "" +
	"\n" +
	"\x14greet/v1/greet.proto\x12\bgreet.v1\"4\n" +
	"\fGreetRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03age\x18\x02 \x01(\x05R\x03age\"=\n" +
	"\rGreetResponse\x12\x1a\n" +
	"\bgreeting\x18\x01 \x01(\tR\bgreeting\x12\x10\n" +
	"\x03age\x18\x02 \x01(\x05R\x03age2J\n" +
	"\fGreetService\x12:\n" +
	"\x05Greet\x12\x16.greet.v1.GreetRequest\x1a\x17.greet.v1.GreetResponse\"\x00B\x1eZ\x1cgo-next/gen/greet/v1;greetv1b\x06proto3"
